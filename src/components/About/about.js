...
const About = () => {
    return (
        <section id="skills">
            <h2 className="skillTitle">Introduction</h2>
            <span className="skillDesc">
                ...
                and personal projects. My soft skills include being a creative designer and thinker in developing ideas, being well-organized 
                and detail-oriented, having proficient team management and communication abilities. 
                I look forward to professional opportunities in Software Engineering where I can enhance my current 
